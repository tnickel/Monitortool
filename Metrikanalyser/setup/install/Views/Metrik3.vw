<View name="Metrik3" originalName="Metrik3">
  <Columns>
    ...
    <Column class="AvgAbsTrade" name="Avg. Abs Trade" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
    <Column class="AvgBarsInTrade" name="Avg. Bars in Trade" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
    <Column class="AvgBarsLoss" name="Avg. Bars Loss" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
    <Column class="AvgBarsWin" name="Avg. Bars Win" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
    <Column class="AvgConsecLosses" name="Avg Consec. Losses" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
    ...
    <Column class="AvgProfitPerMonth" name="Avg. Profit Per Month" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
    ...
    <Column class="DegreesOfFreedom" name="Degrees of freedom" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
    <Column class="Drawdown" name="Drawdown" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
    <Column class="DrawdownPct" name="Max DD %" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
    <Column class="EdgeRatioInPips" name="Edge Ratio" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
    <Column class="Efficiency" name="Efficiency" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
    <Column class="EquityAngle" name="EquityAngle" sampleType="10" direction="0" plType="10" resultType="main" confidenceLevel="50" market="1" subresult="30" showMainResult="true"/>
