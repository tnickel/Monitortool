...
extern int Einstellungs_Number = 0;
...
//---- indicators
   ...
   SetIndexBuffer(5,Buffer_WP6);
    SetIndexStyle(6,DRAW_LINE);
   SetIndexBuffer(6,Buffer_WP7);
    SetIndexStyle(7,DRAW_LINE);
   SetIndexBuffer(7,Buffer_WP8);
...
double ADX_Beschleunigung_double_2()
  {
...
double Force_Beschleunigung_double()
  {
...
bool ATR_Zusatz()
  ...
  double ATR_Zusatz_double()
  {
   double ret=0;
   
   if(iATR(NULL,60,120,1) == 0)  return(0);
   
   ret=iATR(NULL,60,12,1)/iATR(NULL,60,120,1);
