...
public class ShowAllProfits extends ApplicationFrame
{
	private static Tableview tv_glob=null;
	public ShowAllProfits(String title, Tableview tv,ArrayList<Tradeliste> alltradelist)
	{
		...
		DemoPanel panel = new DemoPanel(new GridLayout(100, 2));
	...
	public static void start(ArrayList<Tradeliste> alltradelist)
	{
		...
		ShowAllProfits demo = new ShowAllProfits("Profitanzeige",tv_glob, alltradelist);
		demo.pack();
