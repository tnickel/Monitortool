...
public class Tools extends SG
{
	...
	public static Boolean CheckDateIsOlder(String datestring1, String datestring2)
	{
		
		long dmil1 = get_date_milisec_lo(datestring1);
		long dmil2 = get_date_milisec_lo(datestring2);
