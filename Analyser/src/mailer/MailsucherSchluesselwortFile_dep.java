...
public class MailsucherSchluesselwortFile_dep extends Sucher_dep
{
			...
			String mindat, String schluesselwort, Found found,int maxfilelength,int keineTeilwoerterflag)
	{
		...
		for (int i = 0; i < anz; i++)
		{
			...
			if(fnam.contains("aktienbrief254")==true)
				System.out.println("found 2011-11-30_132408_attach1_aktienbrief254pdf");
			...
			String mindat, Found found, int maxfilegroesse,int keineTeilwoerterflag)
	{
		...
		for (int i = 0; i < anz; i++)
		{
			...
			if(fnam.contains("2011-12-9_163007")==true)
				System.out.println("found 2011-12-9_163007");
